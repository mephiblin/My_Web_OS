  ...
  <div class="summary-grid">
    ...
    <div class="card glass-effect">
      ...
      <div class="progress-bar">
        <div class="fill" style="width: {status.memory.percentage}%"></div>
      </div>
      <div class="stats">
        {(status.memory.used / (1024 ** 3)).toFixed(2)} GB / {(status.memory.total / (1024 ** 3)).toFixed(2)} GB
      </div>
    </div>
  </div>
    ...
    <div class="card glass-effect">
      ...
      {#each status.gpu as g}
        <div class="gpu-item">
          ...
          <div class="extra">{g.vram}MB VRAM</div>
        </div>
      {:else}
  ...
  <div class="storage-section card glass-effect">
    ...
    {#each status.storage as drive}
      <div class="drive">
        ...
        <div class="progress-bar">
          <div class="fill" style="width: {drive.use}%"></div>
        </div>
      </div>
    {/each}
  </div>
